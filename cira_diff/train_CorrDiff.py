""" 
Python file to train an EDM based diffusion model but in the CorrDiff approach. 

The CorrDiff dataset has 3 conditions that are concat to the noisy dimension. Then the prediction is actually the residual between the
U-net prediction and the true forecast. 
