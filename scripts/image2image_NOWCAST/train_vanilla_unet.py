...
class TrainingConfig:
    ...
    output_dir = "/mnt/data1/rchas1/vanilla_unet_10_two_inputs/"  # the local path to store the model 
    push_to_hub = False
...
def train_loop(config, model, optimizer, train_dataloader, lr_scheduler, val_dataloader):
    ...
    if accelerator.is_main_process:
        ...
        writer = SummaryWriter("/mnt/data1/rchas1/vanilla_unet_10_two_inputs/logs/images")
