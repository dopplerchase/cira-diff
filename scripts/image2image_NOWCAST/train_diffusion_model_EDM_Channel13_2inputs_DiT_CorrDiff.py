...
class TrainingConfig:
    ...
    output_dir = "/mnt/data1/rchas1/edm_10_two_inputs_DiT_CorrDiff/"  # the local path to store the model 
    push_to_hub = False 
    ...
    dataset_path = "/mnt/data1/rchas1/diffusion_10_4_2inputs_v2_gh200_CorrDiff.zarr"
...
#inputs are 2 regular data inputs, 1 
model = DiTTransformer2DModel(in_channels=4,  out_channels=1,num_layers=6,patch_size=8)
